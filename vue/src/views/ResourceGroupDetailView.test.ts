...
describe('ResourceGroupDetailView', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    mocks.get.mockResolvedValue({ id: 8, task_id: 9, task_no: 'RW-009', scope_kind: 'sku', sku_code: 'SKU-009', product_name: '北欧客厅组合', creator_name: '李运营', business_lane: 'customization', lock_version: 1, migration_incomplete: false, finalized_revision: { id: 70, group_id: 8, revision_no: 2, status: 'finalized', mode: 'set', source_stage: 'audit', references: [], items: [{ id: 1, revision_id: 70, task_asset_id: 101, sort_order: 0 }] } })
