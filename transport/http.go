...
func NewRouter(
	...
	taskGroup := v1.Group("/tasks")
	{
		...
		taskGroup.POST("/:id/modules/:module_key/actions/:action", capabilityAccess(taskGroup, http.MethodPost, "/:id/modules/:module_key/actions/:action", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision), taskH.ModuleAction)
		...
		taskGroup.POST("/:id/assets/upload-sessions/:session_id/abort", capabilityAccess(taskGroup, http.MethodPost, "/:id/assets/upload-sessions/:session_id/abort", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "remove_after_frontend_migration"), taskAssetCenterH.AbortUploadSession)
		...
		taskGroup.POST("/:id/asset-center/upload-sessions", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/small", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/small", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateSmallUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/multipart", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/multipart", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateMultipartUploadSession)
		taskGroup.GET("/:id/asset-center/upload-sessions/:session_id", capabilityAccess(taskGroup, http.MethodGet, "/:id/asset-center/upload-sessions/:session_id", domain.APIReadinessReadyForFrontend, domain.PermissionTaskView, domain.PermissionAssetView, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}", "remove_after_frontend_migration"), taskAssetCenterH.GetUploadSession)
		...
		taskGroup.POST("/:id/asset-center/upload-sessions/:session_id/cancel", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/:session_id/cancel", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "remove_after_frontend_migration"), taskAssetCenterH.CancelUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/:session_id/abort", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/:session_id/abort", domain.APIReadinessReadyForFrontend, domain.PermissionTaskCreate, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "candidate_for_v1_0_removal"), taskAssetCenterH.AbortUploadSession)
