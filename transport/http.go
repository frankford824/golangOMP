...
func NewRouter(
	...
	taskGroup := v1.Group("/tasks")
	{
		...
		taskGroup.POST("/:id/modules/:module_key/actions/:action", capabilityAccess(taskGroup, http.MethodPost, "/:id/modules/:module_key/actions/:action", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage), taskH.ModuleAction)
		...
		taskGroup.POST("/:id/assign", capabilityAccess(taskGroup, http.MethodPost, "/:id/assign", domain.APIReadinessReadyForFrontend, domain.PermissionTaskManage), taskAssignmentH.Assign)
		...
		taskGroup.POST("/:id/assets/upload-sessions", capabilityAccess(taskGroup, http.MethodPost, "/:id/assets/upload-sessions", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateUploadSession)
		taskGroup.GET("/:id/assets/upload-sessions/:session_id", capabilityAccess(taskGroup, http.MethodGet, "/:id/assets/upload-sessions/:session_id", domain.APIReadinessReadyForFrontend, domain.PermissionTaskView, domain.PermissionAssetView, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}", "remove_after_frontend_migration"), taskAssetCenterH.GetUploadSession)
		taskGroup.POST("/:id/assets/upload-sessions/:session_id/complete", capabilityAccess(taskGroup, http.MethodPost, "/:id/assets/upload-sessions/:session_id/complete", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/complete", "remove_after_frontend_migration"), taskAssetCenterH.CompleteUploadSession)
		taskGroup.POST("/:id/assets/upload-sessions/:session_id/abort", capabilityAccess(taskGroup, http.MethodPost, "/:id/assets/upload-sessions/:session_id/abort", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "remove_after_frontend_migration"), taskAssetCenterH.AbortUploadSession)
		...
		taskGroup.POST("/:id/asset-center/upload-sessions", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/small", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/small", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateSmallUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/multipart", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/multipart", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions", "remove_after_frontend_migration"), taskAssetCenterH.CreateMultipartUploadSession)
		taskGroup.GET("/:id/asset-center/upload-sessions/:session_id", capabilityAccess(taskGroup, http.MethodGet, "/:id/asset-center/upload-sessions/:session_id", domain.APIReadinessReadyForFrontend, domain.PermissionTaskView, domain.PermissionAssetView, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}", "remove_after_frontend_migration"), taskAssetCenterH.GetUploadSession)
		...
		taskGroup.POST("/:id/asset-center/upload-sessions/:session_id/cancel", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/:session_id/cancel", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "remove_after_frontend_migration"), taskAssetCenterH.CancelUploadSession)
		taskGroup.POST("/:id/asset-center/upload-sessions/:session_id/abort", capabilityAccess(taskGroup, http.MethodPost, "/:id/asset-center/upload-sessions/:session_id/abort", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), withCompatibilityRoute("/v1/assets/upload-sessions/{session_id}/cancel", "candidate_for_v1_0_removal"), taskAssetCenterH.AbortUploadSession)
	...
	assetGroup := v1.Group("/assets")
	{
		...
		assetGroup.POST("/upload-sessions", capabilityAccess(assetGroup, http.MethodPost, "/upload-sessions", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), taskAssetCenterH.CreateAssetUploadSession)
		assetGroup.GET("/upload-sessions/:session_id", capabilityAccess(assetGroup, http.MethodGet, "/upload-sessions/:session_id", domain.APIReadinessReadyForFrontend, domain.PermissionTaskView, domain.PermissionAssetView, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), taskAssetCenterH.GetAssetUploadSession)
		...
		assetGroup.POST("/upload-sessions/:session_id/cancel", capabilityAccess(assetGroup, http.MethodPost, "/upload-sessions/:session_id/cancel", domain.APIReadinessReadyForFrontend, domain.PermissionTaskDesignSubmit, domain.PermissionTaskAuditDecision, domain.PermissionTaskManage, domain.PermissionAssetManage), taskAssetCenterH.CancelAssetUploadSession)
