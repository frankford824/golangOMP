...
func registerAssetWorkbenchRoutes(
	...
	group := v1.Group("/asset-workbench")
	{
		...
		group.POST("/upload-sessions", access(group, http.MethodPost, "/upload-sessions", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.CreateUploadSession)
		group.POST("/upload-sessions/:session_id/complete", access(group, http.MethodPost, "/upload-sessions/:session_id/complete", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.CompleteUploadSession)
		group.POST("/upload-sessions/:session_id/cancel", access(group, http.MethodPost, "/upload-sessions/:session_id/cancel", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.CancelUploadSession)
		...
		group.GET("/drive/folder", access(group, http.MethodGet, "/drive/folder", domain.APIReadinessReadyForFrontend, assetWorkbenchRoles()...), assetWorkbenchH.DriveBrowseFolder)
		group.GET("/drive/search", access(group, http.MethodGet, "/drive/search", domain.APIReadinessReadyForFrontend, assetWorkbenchRoles()...), assetWorkbenchH.DriveSearch)
		group.GET("/drive/locate", access(group, http.MethodGet, "/drive/locate", domain.APIReadinessReadyForFrontend, assetWorkbenchRoles()...), assetWorkbenchH.DriveLocate)
		...
		group.POST("/files/batch-delete", access(group, http.MethodPost, "/files/batch-delete", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleSuperAdmin), assetWorkbenchH.BatchDeleteFiles)
		...
		group.GET("/error-imports", access(group, http.MethodGet, "/error-imports", domain.APIReadinessReadyForFrontend, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.ListErrorImports)
		group.GET("/error-imports/:import_id", access(group, http.MethodGet, "/error-imports/:import_id", domain.APIReadinessReadyForFrontend, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.GetErrorImportDetail)
		group.DELETE("/error-imports/:import_id", access(group, http.MethodDelete, "/error-imports/:import_id", domain.APIReadinessReadyForFrontend, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.DeleteErrorImport)
		...
		group.POST("/settlement/batches/:batch_id/reverse-confirmation", access(group, http.MethodPost, "/settlement/batches/:batch_id/reverse-confirmation", domain.APIReadinessReadyForFrontend, domain.RoleSuperAdmin), assetWorkbenchH.ReverseSettlementBatchConfirmation)
		...
		group.POST("/settlement/supplements", access(group, http.MethodPost, "/settlement/supplements", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.CreateSettlementSupplement)
		group.POST("/settlement/supplements/batch-delete", access(group, http.MethodPost, "/settlement/supplements/batch-delete", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.BatchDeleteSettlementSupplements)
		...
		group.DELETE("/settlement/supplements/:supplement_id", access(group, http.MethodDelete, "/settlement/supplements/:supplement_id", domain.APIReadinessReadyForFrontend, domain.RoleAssetSubmitter, domain.RoleAssetManager, domain.RoleAssetSettlement, domain.RoleSuperAdmin), assetWorkbenchH.DeleteSettlementSupplement)
