...
> WebSocket 当前 OpenAPI 真实 path 为 `/ws/v1`，详见 `V1_API_WS.md`，不计入 286 个 `/v1` path。
...
| GET | `/v1/product-management` | List product management records | GET:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
| GET | `/v1/product-management/combo-tree` | List product management records grouped by ERP combo SKU | GET:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
...
| POST | `/v1/asset-workbench/access/open` | Open or restore asset workbench access | POST:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
| POST | `/v1/asset-workbench/access/disable` | Disable asset workbench access | POST:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
| GET | `/v1/asset-workbench/members` | List asset workbench members | GET:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
| PATCH | `/v1/asset-workbench/members/{user_id}/identity` | Deprecated asset workbench binary identity endpoint | PATCH:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
...
| GET, POST | `/v1/asset-workbench/submissions` | List asset workbench submissions；Create asset workbench submission | GET:已登录 / scope-aware; POST:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
...
| POST | `/v1/asset-workbench/upload-sessions` | Create asset workbench upload session | POST:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
| POST | `/v1/asset-workbench/upload-sessions/{session_id}/complete` | Complete asset workbench upload session | POST:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
...
| GET | `/v1/asset-workbench/client-materials/{material_id}/preview` | Get client material preview metadata | GET:已登录 / scope-aware | [V1_API_TASKS.md](V1_API_TASKS.md) |
