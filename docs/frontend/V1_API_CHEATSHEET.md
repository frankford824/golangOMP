...
> WebSocket 当前 OpenAPI 真实 path 为 `/ws/v1`，详见 `V1_API_WS.md`，不计入 211 个 `/v1` path。
...
| POST | `/v1/assets/batch-download` | Batch download assets as ZIP | POST:已登录 / scope-aware | [V1_API_ASSETS.md](V1_API_ASSETS.md) |
