...
> WebSocket 当前 OpenAPI 真实 path 为 `/ws/v1`，详见 `V1_API_WS.md`，不计入 338 个 `/v1` path。
...
| GET, POST | `/v1/asset-workbench/settlement/supplements` | List asset workbench settlement supplements；Create asset workbench settlement supplement | GET:AssetSettlement, SuperAdmin; POST:AssetSettlement, SuperAdmin | [V1_API_TASKS.md](V1_API_TASKS.md) |
...
| POST | `/v1/assets/upload-sessions` | Create asset upload session | POST:Designer, CustomizationOperator, Ops, Admin, SuperAdmin, HRAdmin, RoleAdmin, DepartmentAdmin, TeamLead, DesignDirector | [V1_API_ASSETS.md](V1_API_ASSETS.md) |
