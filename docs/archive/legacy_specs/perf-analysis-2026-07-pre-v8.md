# 运营系统接口与检索查询性能分析报告 (Historical pre-V8 snapshot)

> This report describes routes and read models that were later retired. It is preserved only as performance evidence and must not be used as a current API or product contract.
