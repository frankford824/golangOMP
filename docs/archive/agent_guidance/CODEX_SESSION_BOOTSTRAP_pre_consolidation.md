> HISTORICAL SNAPSHOT ONLY. Superseded by `prompts/CODEX_SESSION_BOOTSTRAP.md` and root `AGENTS.md`.
> Preserved from commit 9a418a6d38ba3e99c575e833f80957e173faf876. The baseline and commands below are historical evidence, not current instructions or authorization.
