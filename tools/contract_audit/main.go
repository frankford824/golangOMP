...
var knownGapReasons = map[string]string{
	...
	knownGapKey("DELETE", "/v1/me/avatar"):                                                      "legitimate-reserved-placeholder-route",
	...
	knownGapKey("GET", "/v1/erp/combine-skus"):                                                  "tool-deref-limit-mounted-route-contract-pending",
	knownGapKey("GET", "/v1/erp/iids"):                                                          "tool-deref-limit-dynamic-payload-documented",
	knownGapKey("GET", "/v1/erp/order-action-logs"):                                             "tool-deref-limit-mounted-route-contract-pending",
	...
	knownGapKey("GET", "/v1/product-management/combo-tree"):                                     "tool-deref-limit-mounted-route-contract-pending",
	...
	knownGapKey("GET", "/v1/reports/business-trends/deep-analysis-jobs/:job_id"):                "tool-deref-limit-mounted-route-contract-pending",
	...
	knownGapKey("POST", "/v1/reports/business-trends/deep-analysis-jobs"):                       "tool-deref-limit-mounted-route-contract-pending",
	knownGapKey("POST", "/v1/reports/business-trends/pilot-analysis"):                           "tool-deref-limit-mounted-route-contract-pending",
	...
	knownGapKey("POST", "/v1/users/:id/deactivate"):                                             "legitimate-reserved-placeholder-route",
