...
INSERT IGNORE INTO cost_rules (
  ...
  ('红色KT板基础单价', 'KT_RED', 'board', 'fixed_unit_price', 4.50, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '固定单价样例'),
  ('金色KT板基础单价', 'KT_GOLD', 'board', 'fixed_unit_price', 6.50, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '固定单价样例'),
  ('常规覆膜KT板基础单价', 'KT_STANDARD_FILM', 'board', 'fixed_unit_price', 13.00, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '覆膜基础单价'),
  ('常规覆膜KT板小面积保底', 'KT_STANDARD_FILM', 'board', 'minimum_billable_area', NULL, NULL, 0.1500, NULL, NULL, '', NULL, '', 5, 1, 'phase_020_sample', '覆膜小面积保底骨架'),
  ('定制覆膜KT板基础单价', 'KT_CUSTOM_FILM', 'board', 'fixed_unit_price', 13.00, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '覆膜基础单价'),
  ('定制覆膜KT板小面积保底', 'KT_CUSTOM_FILM', 'board', 'minimum_billable_area', NULL, NULL, 0.1500, NULL, NULL, '', NULL, '', 5, 1, 'phase_020_sample', '覆膜小面积保底骨架'),
  ('常规写真布基础单价', 'PHOTO_CLOTH_STANDARD', 'cloth', 'fixed_unit_price', 5.00, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '布类基础单价'),
  ('常规写真布小面积附加', 'PHOTO_CLOTH_STANDARD', 'cloth', 'area_threshold_surcharge', NULL, 1.1000, NULL, 0.1500, 3.00, '', NULL, '', 20, 1, 'phase_020_sample', '面积低于阈值加价'),
  ('定制写真布基础单价', 'PHOTO_CLOTH_CUSTOM', 'cloth', 'fixed_unit_price', 5.00, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '布类基础单价'),
