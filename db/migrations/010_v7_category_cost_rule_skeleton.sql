...
INSERT IGNORE INTO categories (
  ...
  ('POSTER_STANDARD', '常规海报', '常规海报', NULL, 1, 'cloth', 1, 95, 'phase_020_sample', '一级总分类入口样例'),
...
INSERT IGNORE INTO cost_rules (
  ...
  ('常规海报基础单价', 'POSTER_STANDARD', 'cloth', 'fixed_unit_price', 5.00, 1.1000, NULL, NULL, NULL, '', NULL, '', 10, 1, 'phase_020_sample', '海报按面积计价'),
  ('常规海报小面积附加', 'POSTER_STANDARD', 'cloth', 'area_threshold_surcharge', NULL, 1.1000, NULL, 0.1500, 3.00, '', NULL, '', 20, 1, 'phase_020_sample', '单件面积低于阈值加价'),
