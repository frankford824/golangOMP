...
const (
	...
	TaskEventAuditReturnedToDesign       = "task.audit.returned_to_design"
	...
	TaskEventSKUItemUpdated              = "task.sku_item.updated"
	...
	TaskEventERPImageAwaitingUpload      = "task.erp_image.awaiting_upload"
