...
var npdFields = []FieldSpec{
	...
	},
	{
		...
		Key:           "material_mode",
		Required:      true,
		AllowedValues: []string{string(domain.MaterialModePreset), string(domain.MaterialModeOther)},
		Format:        FieldFormatString,
		HelpText:      "preset 或 other",
		ViolationCodes: ViolationCodeSet{
			Missing: "missing_required_field",
			Invalid: "invalid_material_mode",
		},
	},
	{
		Column:   "设计要求",
